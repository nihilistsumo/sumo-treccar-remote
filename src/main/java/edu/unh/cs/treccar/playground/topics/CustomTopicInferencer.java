...
public class CustomTopicInferencer implements Serializable {
	...
	public CustomTopicInferencer (int[][] typeTopicCounts, int[] tokensPerTopic, Alphabet alphabet,
	...
	public static CustomTopicInferencer read (File f) throws Exception {

		CustomTopicInferencer inferencer = null;

		ObjectInputStream ois = new ObjectInputStream (new FileInputStream(f));
		inferencer = (CustomTopicInferencer) ois.readObject();
		ois.close();
